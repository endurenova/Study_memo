...
# sep: 현재 운영체제에서 사용하는 경로 구분 기호로 자동 출력 -------------------------------------------------------------------
os.path.sep
...
# rmdir: 디렉토리 삭제 ---------------------------------------------------------------------------------------------------
os.rmdir("새 폴더")  # 디렉토리가 비어있어야 삭제 가능
...
# copytree: 트리구조를 포함한 파일 복사 ------------------------------------------------------------------------------------
shutil.copytree("원본 파일 이름", "복제한 파일 이름")

# rmtree: 트리구조를 포함한 파일 삭제 --------------------------------------------------------------------------------------
shutil.rmtree("삭제할 폴더 혹은 파일 이름")
...
# make_archive: 폴더 전체를 하나의 파일로 압축 ------------------------------------------------------------------------------
shutil.make_archive("압축 폴더 이름", "압축 방식(zip)", "압축하고 싶은 폴더의 경로")

# unpack_archive: 압축해제 ----------------------------------------------------------------------------------------------
shutil.unpack_archive("압축 파일.zip", "압축 해제할 폴더")
